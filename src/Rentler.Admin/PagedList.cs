...
{
    /// <summary>
    /// Serializable list of items designed to be returned
    /// with a web api.
    /// </summary>
    /// <typeparam name="T">Type of item to be paged.</typeparam>
    [DataContract]
    public class PagedList<T>
    {
        ...
        public PagedList(IQueryable<T> source, int pageNumber, int pageSize)
        {
            ...
            if (this.PageSize < 1)
            {
                ...
                this.Items.AddRange(source.Skip(PageNumber * PageSize - PageSize).Take(PageSize));
        }
